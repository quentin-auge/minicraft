...
- **Pigeons**: `PIGEON_COUNT` 50 flying mobs, Overworld only, cruising at
  ...
  clouds and player builds both count — pure collision, no band gating) and steers
  through yaw/vertical candidates;
